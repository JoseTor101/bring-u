...
class ChatSystem(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        ...
        username = text_data_json['username']
         # Retrieve the Chat object based on the room_name or room ID
           # Use database_sync_to_async to perform database operation
        ...
        await database_sync_to_async(Message.objects.create)(sender=user_sender, content=message, fk_id_chat=chat)
